...
public class ReporteController {
    ...
    public ResponseEntity<Resource> reporteUsuariosRoles(@RequestParam String tipo) 
            throws IOException {
        var reporte="usuariosRoles";
        return reporteService.generaReporte(reporte, null, tipo);
    }
    @GetMapping("/ventasRoles")
    public ResponseEntity<Resource> reporteVentasRoles(@RequestParam String tipo) 
            throws IOException {
        var reporte="ventasRoles";
        return reporteService.generaReporte(reporte, null, tipo);
    }
}
